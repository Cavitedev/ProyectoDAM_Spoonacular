...
public class RoomConstantes {
    ...
    public static final String NUTRIENTES_NOMBRE_TABLA = "nutrientes";
    public static final String PESOUNIDAD_NOMBRE_TABLA = "peso_unidad";
    public static final String PROPIEDAD_NOMBRE_TABLA = "propiedades";
    public static final String VALORESTIMADO_NOMBRE_TABLA = "valor_estimado";
