...
public class NutricionRoomDto implements IADominio<Nutricion> {
    ...
    public NutricionRoomDto(Nutricion dominio) {
        ...
        nutrientesDominioALocal(dominio);

        propiedadesDominioALocal(dominio);
    ...
    private void nutrientesDominioALocal(Nutricion dominio) {
        if (dominio.getNutrientes() == null) return;
    ...
    private void propiedadesDominioALocal(Nutricion dominio) {
        if (dominio.getPropiedades() == null) return;
    ...
    public Nutricion aDominio() {
        ...
        DescomposicionCalorica descomposicionCalorica = null;
        if (this.descomposicionCalorica != null)
            descomposicionCalorica = this.descomposicionCalorica.aDominio();

        PesoUnidad pesoPorRacion = null;
        if (this.pesoPorRacion != null)
            pesoPorRacion = this.pesoPorRacion.aDominio();


        return new Nutricion(nutrientes
                , propiedades
                , descomposicionCalorica
                , pesoPorRacion);
    }
